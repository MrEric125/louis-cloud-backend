...
public class LicenseService {
    ...
    private List<License> randomRunLong(String orgId) {
        ...
        License license = License.builder().id(String.valueOf(anInt)).build();
    ...
    private List<License> defaultListLicense(String orgId) {
       return Lists.newArrayList(License.builder().id(orgId).build());
    ...
    @HystrixCommand(fallbackMethod = "defaultListLicense2",threadPoolKey = "licenseByOrgThreadpool",
        threadPoolProperties = { @HystrixProperty(name = "coreSize", value = "30")
    ,@HystrixProperty(name = "maxQueueSize",value = "10")})
    public List<License> getLicenseByOrg2(String orgId) {
        return randomRunLong(orgId);
    }
